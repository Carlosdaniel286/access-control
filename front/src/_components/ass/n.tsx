...
export function DialogContentPerson({ onButtonClick }: DialogProps) {
  ...
  return (
    <div className="overflow-y-auto overflow-x-hidden max-h-[100dvh] sm:max-h-[95dvh] snap-y pr-4 sm:rounded-lg shadow-lg">
      <div className="bg-white flex flex-col pb-10 px-2 py-5 sm:px-10 sm:rounded-lg shadow-lg">
        ...
        >
          <div className="flex md:flex-row-reverse" style={{ gridArea: "image" }}>
