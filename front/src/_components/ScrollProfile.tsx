  ...
  const[open,setOpen]=React.useState(false)
    ...
    >
      ...
      <List   sx={{background:'oklch(97% 0.014 254.604)',padding:'0px',margin:'0px'}}  >
         <ListSubheader  sx={{fontSize:'1rem',gap:'13px',margin:'7px',display:'flex' }} 
        sticky>
           <p className='block   md:hidden'>painel de movimentação diaria</p>
           <div  className=" px-1 w-[80px] hidden sm:min-w-[90px] md:block md:min-w-[100px]  lg:min-w-[100px]"></div>
